...
from .views import (
    ...
    exportar_pedidos_csv,  # Adicionado
...
urlpatterns = [
    ...
    path('exportar-pedidos/', exportar_pedidos_csv, name='exportar_pedidos'),  # Adicionado
    path('exportar-pedidos-pdf/', exportar_pedidos_pdf, name='exportar_pedidos_pdf'),  # Adicionado
]