...
class Supplier(models.Model):
    ...
    departments = models.ManyToManyField('products.Departamento', related_name='suppliers', null=True, blank=True)
    categories = models.ManyToManyField(Category, null=True, blank=True, verbose_name="Categorias")
    subcategories = models.ManyToManyField(Subcategory, null=True, blank=True, verbose_name="Subcategorias")
    brands = models.ManyToManyField(Brand, null=True, blank=True, verbose_name="Marcas")
