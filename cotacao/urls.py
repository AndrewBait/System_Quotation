...
from .views import ProdutoAPI, DepartamentoAPI, CategoriaAPI, SubcategoriaAPI, ItensCotacaoAPI, CotacaoCreateView, AddProductToCotacaoView, ProductAutocomplete
