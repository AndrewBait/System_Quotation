...
AddProductToCotacaoView, ProductAutocomplete, ToggleCotacaoStatusView, CotacaoUpdateView, CotacaoDeleteView, CotacaoListView, CotacaoMainView)
...
urlpatterns = [
    ...
    path('main/', CotacaoMainView.as_view(), name='cotacoes'),
